...
class UnsafeSituationsScreen extends StatefulWidget {
  ...
  @override
  State<UnsafeSituationsScreen> createState() => _UnsafeSituationsScreenState();
}

class _UnsafeSituationsScreenState extends State<UnsafeSituationsScreen> {
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final isWarning = classification == 'ID';
                            ...
                            return AppEntityCard(
                              ...
                              onTap: () => _showObservationDetails(situation),
                            );
                          },
                        ),
                      ),
