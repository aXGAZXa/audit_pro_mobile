...
void main() {
  test(
    'computes schema v4 HNA derived metrics from representative payload data',
    () {
      ...
      expect(
        metrics['dwellingMeteringFeasibility'],
        'Further investigation required',
      );
      expect(
        metrics['dwellingHeatingMeterFeasibility'],
        'Variable feasibility',
      );
      expect(
        metrics['dwellingDhwMeterFeasibility'],
        'Further investigation required',
      );
